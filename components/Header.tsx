...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 w-full bg-[#111110]/70 backdrop-blur-sm px-6 py-6 md:px-12 md:py-8">
      <div>
        <Image
      ...
      <nav className="hidden items-center gap-10 text-[13px] font-normal uppercase leading-[20px] tracking-[0.15em] text-[#F5F2EC]/80 lg:flex">
